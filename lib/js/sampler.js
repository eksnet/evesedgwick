...
$(document).ready (function () {
	hidePopupBox();
	$(".menu").parent().children(".sub_menu").hide();
	showCurrentMenuItem();
	function showCurrentMenuItem() {
		sub_menu = $(".current").parents(".sub_menu");
		sub_menu.show();
	...
	$(".menu").children('a').click(function(){
		...
		if(sub_menu.attr("visible") == 'true') {
			sub_menu.hide('blind', { direction: 'vertical' }, 200);
			sub_menu.attr("visible", 'false');
			/*$(this).css("background-image", "url(images/arrows/arrow-right.png)")*/
		} else {
			sub_menu.show('blind', { direction: 'vertical' }, 200);
			sub_menu.attr("visible", 'true');
		/*	$(this).css("background-image", "url(images/arrows/arrow-down.png)")*/
		}
	});
	...
	$(".menu").click(function(){
		...
		if(sub_menu.attr("visible") == 'true') {
			sub_menu.hide('blind', { direction: 'vertical' }, 200);
			sub_menu.attr("visible", 'false');
			$(this).children(".v_marker").empty();
			$(this).children(".v_marker").text("- ");
			/*$(this).css("background-image", "url(images/arrows/arrow-right.png)")*/
		} else {
			sub_menu.show('blind', { direction: 'vertical' }, 200);
			sub_menu.attr("visible", 'true');
...
// Popup Box
	...
	function hidePopupBox() {
	  //alert("Entering hidePopup");
		$('.popup_box').addClass('inv');
	}
