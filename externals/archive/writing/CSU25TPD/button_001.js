...
function openLogin()
{
	...
	var newWindow = window.open('https://getpocket.com/create'+paramStr(btnData),"pkt_button_"+(iLi?'1':'0'),"left="+x+",top="+y+",width="+w+",height="+h+",personalbar=no,toolbar=no,scrollbars=yes,location=yes,resizable=yes");
