...
var sitecodePrefixCHE='che:';var sitecodeSAccountCHED='chroneduglobaldev';var sitecodeSAccountCHEP='chroneduglobal,chroneduprodv2';var sitecodePrefixCOP='cop:';var sitecodeSAccountCOPD='chronedubuildphil';var sitecodeSAccountCOPP='chroneduphilprodv2';if(!Z||!s_account)
{var hostname=window.location.hostname;if(/philanthropy/i.test(hostname)||(Z&&Z==sitecodePrefixCOP))
{if(!Z){var Z=sitecodePrefixCOP;}
if(!s_account){var s_account;if(/(build.cubic|cubic|cloud|localhost)/i.test(hostname))
{s_account=sitecodeSAccountCOPD;}else{s_account=sitecodeSAccountCOPP;}}}
else if(/chronicle/i.test(hostname)||(Z&&Z==sitecodePrefixCHE))
{if(!Z){var Z=sitecodePrefixCHE;}
if(!s_account){var s_account;if(/(build.cubic|cubic|cloud|localhost)/i.test(hostname))
{s_account=sitecodeSAccountCHED;}else{s_account=sitecodeSAccountCHEP;}}}
else{if(!Z){var Z='unknown:';}
if(!s_account){var s_account=sitecodeSAccountCHED;}}}
var s=s_gi(s_account);function s_doPlugins(s){var sp7,sprop7,sp42,sprop42,sp43,sprop43,sp44,sprop44,sp45,p_type='',p_id='';if(s.prop7){sp7=s.prop7;sprop7=s.getValOnce(s.prop7,'s_prop7',0)}
if(s.prop42){sp42=s.prop42;sprop42=s.getValOnce(s.prop42,'s_prop42',0)}
if(s.prop43){sp43=s.prop43;sprop43=s.getValOnce(s.prop43,'s_prop43',0)}
if(s.prop44){sp44=s.prop44;sprop44=s.getValOnce(s.prop44,'s_prop44',0)}
if(s.prop45){sp45=s.prop45}
s.prop7=s.prop42=s.prop43=s.prop44=s.prop45='';if(s.eVar48=='1'){if(sprop7||sprop42){s.addEvent('event1');s.eVar67='+1';s.prop7=Z+sp7;s.eVar7='D=c7';if(sprop42){s.prop42=Z+sp42}else{s.prop42=Z+'[no facet]'}
s.eVar58='D=c42';s.prop45=Z+sp45;}else if(s.channel=="jobs"||sprop43||sprop44){s.addEvent('event19');s.eVar68='+1';s.prop43=Z+sp43;s.eVar59='D=c43';if(sprop44){s.prop44=Z+sp44}else{s.prop44=Z+'[no facet]'}
s.eVar60='D=c44';s.prop45=Z+sp45;}}
if(!s.channel&&u1=='blognetwork'){s.channel='blogs';s.prop1=u1;s.prop3=u2;}
if(u1=='myaccount'&&u2=='logout'&&s.prop20=='logged out'){s.getValOnce('0','sp46',0);}
if(!s.prop6&&isFinite(u3)){s.prop6=u3;}else if(s.prop6){p_id=':'+s.prop6;if((Z=='che:'&&s.prop6=='5')||(Z=='cop:'&&s.prop6=='172')){p_type='home';}}
if(s.prop4){s.prop4=s.prop4.replace(/\|/gi,':');var e=s.prop4.split(':')[0];s.prop48=Z+e;if(!p_type){p_type=e}
if(e=='article'||e=='blogpost'){s.addEvent('event45');s.addEvent('event49');s.eVar72='+1';if(!s.prop2){s.prop2=$('.byline').text().substring(3).toLowerCase().replace(' and ','|').replace(', ','|').replace(/\s+/g,'-').replace(/\.|,|'/g,'');}}}
if(u1=='forums'){s.addEvent('event50');if(s.prop1){s.eVar70=Z+s.prop1}
if(u3&&u3.split(',')[0]=='topic'){s.addEvent('event45');s.eVar72='+2';}}
if(s.channel=='jobs'){if(sp43&&s.eVar48){s.prop49='job search:'+sp43+':page '+s.eVar48;}
if(s.prop13&&u1=='jobs'){s.addEvent('event23');s.addEvent('event45');s.eVar72='+3';}}
if(s.products){if(s.channel=='jobs'){s.addEvent('event56');}}
s.addEvent('event2');if(!s.server){s.server=u0}
if(!s.prop8){s.prop8=s.getClientTime('t','15')}
if(!s.prop9){s.prop9=s.getClientTime('d')}
if(!s.prop25){s.prop25='visit '+s.getVisitNum()}
if(!s.channel){s.channel=Z+'home'}else{s.channel=Z+s.channel}
if(!p_id&&s.eVar48){p_id=' results'}
if(!s.pageName){s.pageName=Z+p_type+p_id}
if(s.prop20){var sp20=s.getValOnce(s.prop20,'sp20',0)}
if(s.prop46){var sp46=s.getValOnce(s.prop46,'sp46',0)}
if(sp46&&sp20=='logged in'){s.addEvent('event12');s.eVar66='+1';}
s.prop41=s.getPreviousPage();s.prop41=s.prop41.replace(/(che:|cop:)/gi,'');if(!s.campaign){s.campaign=s.getQueryParam('cid')}
if(s.campaign){var scamp=s.getAndPersistValue(s.campaign,'per_camp');s.campaign=s.getValOnce(s.campaign,'s_campaign',0)}
if(scamp){s.prop47=scamp+":"+s.pageName.replace(':','|')}
if(!s.eVar38){s.eVar38=s.getQueryParam('intcmp')}
if(s.eVar38){s.addEvent('event52')}
if(!s.prop1){s.prop1='[no sub-section]'}
if(s.prop1){s.prop1=Z+s.prop1;s.eVar1='D=c1'}
if(!s.prop2){s.prop2='[no author]'}
if(s.prop2){s.prop2=Z+s.prop2;s.eVar2='D=c2'}
if(!s.prop3){s.prop3='[no sub sub-section]'}
if(s.prop3){s.prop3=Z+s.prop3;s.eVar3='D=c3'}
if(s.prop4){s.prop4=Z+s.prop4;s.eVar4='D=c4'}
if(!s.prop5){s.prop5='[no title]'}
if(s.prop5){s.prop5=Z+s.prop5;s.eVar5='D=c5'}
if(!s.prop6){s.prop6='[no id]'}
if(s.prop6){s.prop6=Z+s.prop6;s.eVar6='D=c6'}
if(s.prop8){s.eVar8='D=c8'}
if(s.prop9){s.eVar9='D=c9'}
if(s.eVar12){s.eVar12=Z+s.eVar12}
if(s.prop13){s.prop13=Z+s.prop13}
if(s.eVar13){s.eVar13=Z+s.eVar13}
if(s.eVar14){s.eVar14=Z+s.eVar14}
if(s.eVar15){s.eVar15=Z+s.eVar15}
if(s.eVar16){s.eVar16=Z+s.eVar16}
if(s.eVar17){s.eVar17=Z+s.eVar17}
if(s.prop18){s.prop18=Z+s.prop18;s.eVar18='D=c18'}
if(s.prop20){s.prop20=Z+s.prop20;s.eVar20='D=c20'}
if(s.prop25){s.eVar25='D=c25'}
if(!s.prop40){s.prop40='[no site license school id]'}
if(s.prop40){s.prop40=Z+s.prop40;s.eVar45='D=c40'}
if(s.prop41){s.prop41=Z+s.prop41;s.eVar56='D=c41'}
if(s.eVar41){s.eVar41=Z+s.eVar41}
if(s.prop46){s.eVar19='D=c46'}
if(s.pageName){s.eVar11='D=pageName'}
if(s.server){s.eVar61='D=server'}
if(s.channel){s.eVar62='D=ch'}
if(s.eVar48){s.eVar48=''}}
s.doPlugins=s_doPlugins;function sc_newsletter(action,name){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar63,events';s.linkTrackEvents=s.events='subscribe'==action?'event5':'event48';s.eVar63=Z+name;s.tl(true,'o',Z+'newsletter '+action);s.linkTrackVars=s.linkTrackEvents=''}
function sc_content_email(){var a,e,s=s_gi(s_account);"jobs"==u1?(a="jobs",e="27"):(a="content",e="41");s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event'+e;s.tl(true,'o',Z+a+'-share:email');s.linkTrackVars=s.linkTrackEvents=''}
function sc_track_comment(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event43';s.tl(true,'o',Z+'content comment');s.linkTrackVars=s.linkTrackEvents=''}
function sc_sponad_click(adid){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='products,events';s.linkTrackEvents=s.events='event57';s.products=";sponad:"+adid+";;;event57=1";s.tl(true,'o',Z+'sponsored ad click');s.linkTrackVars=s.linkTrackEvents=''}
function sc_jobapply_click(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event26';s.tl(true,'o',Z+'job apply click');s.linkTrackVars=s.linkTrackEvents=''}
function sc_jobsave_click(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event25';s.tl(true,'o',Z+'job save click');s.linkTrackVars=s.linkTrackEvents=''}
function sc_jobsite_click(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event24';s.tl(true,'o','job site click');s.linkTrackVars=s.linkTrackEvents=''}
function sc_jobsearch_save(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event32';s.tl(true,'o',Z+'job search save');s.linkTrackVars=s.linkTrackEvents=''}
function sc_content_share(service){var a,e,s=s_gi(s_account);"jobs"==u1?(a="jobs",e="29"):(a="content",e="44");if(service=="email"){if(e=="44")e="41";if(e=="29")e="27";}
s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar72,eVar57,events';s.linkTrackEvents=s.events='event'+e;s.eVar72='+2';s.eVar57=service;s.tl(true,'o',Z+a+'-share:st');s.linkTrackVars=s.linkTrackEvents=''}
$(document).ready(function(){$('.print-btn').click(function(){var a,e,s=s_gi(s_account);"jobs"==u1?(a="jobs",e="28"):(a="content",e="42");s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event'+e;s.tl(true,'o',Z+a+'-share:print');s.linkTrackVars=s.linkTrackEvents='';});$('#share-popup a').click(function(){var a,b,e,s=s_gi(s_account);b=$(this).text().toLowerCase();"jobs"==u1?(a="jobs",e="29"):(a="content",e="44");s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar57,events';s.linkTrackEvents=s.events='event'+e;s.eVar57=Z+b;s.tl(true,'o',Z+a+'-share:social');s.linkTrackVars=s.linkTrackEvents=''});$("#postmodify").submit(function(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events';s.linkTrackEvents=s.events='event6';s.tl(true,'o',Z+'forum reply submitted');s.linkTrackVars=s.linkTrackEvents=s.events=''});$(".titlebg2 form").submit(function(){var b,s=s_gi(s_account);b=$(".titlebg2 [name=search]").val().toLowerCase();s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar71,events';s.linkTrackEvents=s.events='event51';s.eVar71=Z+b;s.tl(true,'o',Z+'forum search');s.linkTrackVars=s.linkTrackEvents=''});$("#searchform").submit(function(){var b,s=s_gi(s_account);b=$("#searchform [name=search]").val().toLowerCase();s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar71,events';s.linkTrackEvents=s.events='event51';s.eVar71=Z+b;s.tl(true,'o',Z+'forum search');s.linkTrackVars=s.linkTrackEvents=''});$('.windowbg form').submit(function(){var b,s=s_gi(s_account);b=$('.windowbg [name=search]').val().toLowerCase();s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar71,events';s.linkTrackEvents=s.events='event51';s.eVar71=Z+b;s.tl(true,'o',Z+'forum search');s.linkTrackVars=s.linkTrackEvents=''});$('[name=profForm]').submit(function(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar50,eVar51,eVar52,eVar53,eVar54,eVar55,events';s.linkTrackEvents=s.events='event30';s.eVar50=Z+$('[name=city]').val().toLowerCase().replace(/[^\w\s]/gi,'');s.eVar51=Z+$('[name=state] option:selected').text().toLowerCase().replace(/[^\w\s]/gi,'');s.eVar52=Z+$('[name=taxonomy1] option:selected').text().toLowerCase();s.eVar53=Z+$('[name=years1] option:selected').text();s.eVar54=Z+$('[name=\'locations[]\'] option:selected').map(function(){return this.text.toLowerCase().replace(/[^\w\s]/gi,'');}).get().join('|');s.eVar55=1==$('input[name=confidential]:checked').val()?Z+'public':Z+'private';s.tl(this,'o',Z+'new resume submit');s.linkTrackVars=s.linkTrackEvents=''});});var megamenu_click=function(item_clicked){var a,e,s=s_gi(s_account);e=16;data_location=item_clicked.attr('data-omniture-location')||'widgetlocationmissing';data_widget=item_clicked.attr('data-omniture-widget')||'widgetnamemissing';if(data_widget=='widgetnamemissing')
{mm_data_menu=item_clicked.closest('section[data-menu].dropdown-menu').attr('data-menu')||false;if(mm_data_menu)
data_widget=mm_data_menu+'-missing';}
zone_name=data_location+":"+data_widget;s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar39,eVar40,events';s.linkTrackEvents=s.events='event'+e;s.eVar39=zone_name;s.eVar40=item_clicked.attr('data-omniture-context-item')||'widgetcontextmissing';s.tl(true,'o',Z+'megamenu');s.linkTrackVars=s.linkTrackEvents=''}
var jquery_ver=((typeof jQuery!='undefined')?jQuery.fn.jquery:0);if(/1\.[7-9]\.[0-9]/.test(jquery_ver)||/2\.[0-9]\.[0-9]/.test(jquery_ver))
{$(document).on('click','section[data-menu].dropdown-menu a, section[data-menu].dropdown-menu button',function(){megamenu_click($(this));});}
else if(/1\.4\.[2-9]/.test(jquery_ver)||/1\.[5-6]\.[0-9]/.test(jquery_ver))
{$(document).delegate('section[data-menu].dropdown-menu a, section[data-menu].dropdown-menu button','click',function(){megamenu_click($(this));});}
else if(/1\.3\.[2-9]/.test(jquery_ver)||/1\.4\.[0-1]/.test(jquery_ver))
{$('section[data-menu].dropdown-menu a, section[data-menu].dropdown-menu button').live('click',function(){megamenu_click($(this));});}
function linkCode(obj,values,params)
{}
s.currencyCode='USD';s.charSet='ISO-8859-1';s.linkLeaveQueryString=false;s.linkTrackEvents=s.linkTrackVars='None';s.trackingServer='thechronicleofhighereducation.122.2o7.net';s.linkDownloadFileTypes='exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx';s.trackExternalLinks=s.trackDownloadLinks=s.trackInlineStats=s.debugTracking=s.usePlugins=true;s.linkInternalFilters='javascript:,chronicle.com,philanthropy.com,chroniclereview.com,chroniclepoll.com,chroniclegallup.com,chroniclevitae.com';s.debugTracking=false;s.addEvent=function(v){var s=this,i,n,a,m=0,L=s.events,d=',';if(L){a=L.split(d);for(i=0;i<a.length;i++){n=a[i];m=m||n==v;}}if(!m)L=L?L+d+v:v;s.events=L;return s.events;}
s.getAndPersistValue=new Function("v","c","e","var s=this,a=new Date;e=e?e:0;a.setTime(a.getTime()+e*86400000);if(v)s.c_w(c,v,e?a:0);return s.c_r(c);");s.getClientTime=new Function("v","i","var dc=new Date('1/1/2000'),d=new Date(),x;if(dc.getDay()!=6)return;if(v=='t'){var h=d.getHours(),m=d.getMinutes(),r,ap='am';if(h>=12){ap='pm';h=h-12}if(h==0)h=12;if(i==30){r='30';if(m<30)r='00';}if(i==15){r='45';if(m<45)r='30';if(m<30)r='15';if(m<15)r='00';}return h+':'+r+ap;}if(v=='d'){var n=d.getDay(),o=['sunday','monday','tuesday','wednesday','thursday','friday','saturday'];return o[n];}");s.getPreviousPage=function(){var s=this,t=new Date,r='',c='s_pv_pn',v=s.pageName;t.setTime(t.getTime()+1800000);if(s.c_r(c))r=s.c_r(c);v?s.c_w(c,v,t):s.c_w(c,'no value',t);return r;}
s.getQueryParam=new Function("p","d","u","h","var s=this,v='',i,j,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.location);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p.length:i;t=s.p_gpv(p.substring(0,i),u+'',h);if(t){t=t.indexOf('#')>-1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substring(i==p.length?i:i+1)}return v");s.getValOnce=new Function("v","c","e","t","var s=this,a=new Date,v=v?v:'',c=c?c:'s_gvo',e=e?e:0,i=t=='m'?60000:86400000;k=s.c_r(c);if(v){a.setTime(a.getTime()+e*i);s.c_w(c,v,e==0?0:a);}return v==k?'':v");s.getVisitNum=new Function("var s=this,e=new Date(),cval,cvisit,ct=e.getTime(),c='s_vnum',c2='s_invisit';e.setTime(ct+30*24*60*60*1000);cval=s.c_r(c);if(cval){var i=cval.indexOf('&vn='),str=cval.substring(i+4,cval.length),k;}cvisit=s.c_r(c2);if(cvisit){if(str){e.setTime(ct+30*60*1000);s.c_w(c2,'true',e);return str;}else return 'unknown visit number';}else{if(str){str++;k=cval.substring(0,i);e.setTime(k);s.c_w(c,k+'&vn='+str,e);e.setTime(ct+30*60*1000);s.c_w(c2,'true',e);return str;}else{s.c_w(c,ct+30*24*60*60*1000+'&vn=1',e);e.setTime(ct+30*60*1000);s.c_w(c2,'true',e);return 1;}}");s.p_gvf=new Function("t","k","if(t){var s=this,i=t.indexOf('='),p=i<0?t:t.substring(0,i),v=i<0?'True':t.substring(i+1);if(p.toLowerCase()==k.toLowerCase())return s.epa(v)}return''");s.p_gpv=new Function("k","u","h","var s=this,v='',q;j=h==1?'#':'?';i=u.indexOf(j);if(k&&i>-1){q=u.substring(i+1);v=s.pt(q,'&','p_gvf',k)}return v");s.setupFormAnalysis=new Function(""
...
+"var s=this,f=s.fa,x=f.cnt;x=x?x+1:1;f.cnt=x;return x==a?e:'';");var u0,u1,u2,u3,wlh=window.location.href.split('/');if(wlh[2]){u0=wlh[2].toLowerCase()}if(wlh[3]){u1=wlh[3].toLowerCase()}if(wlh[4]){u2=wlh[4].toLowerCase()}if(wlh[5]){u3=wlh[5].toLowerCase()}
