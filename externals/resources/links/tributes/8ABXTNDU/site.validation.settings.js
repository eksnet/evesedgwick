...
$.validator.setDefaults({
    ...
    showErrors: function(errorMap, errorList) {
        ...
        if ( $('#modalFrame').length && ( window.location !== top.location.href) )
        {
			...
			if ($('[id^=modal-iframe]', window.parent.document).length) {
            	$('[id^=modal-iframe]', window.parent.document).attr({'style': 'height:auto; min-height:'+height+'px; width:'+width+'px;'});
			} else if ( $('#frameModal iframe', window.parent.document).length ) {
            	$('#frameModal iframe', window.parent.document).attr({'style': 'height:auto; min-height:'+height+'px; width:'+width+'px;'});
			}
        }
