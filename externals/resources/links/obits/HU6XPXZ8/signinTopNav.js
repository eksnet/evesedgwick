/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/button-facebook.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/button-google-plus.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/button-linkedin.js */
(function() {
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/button-tweet.js */
jQ(function ($) {
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/convertJSONtoAd.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/floating-share-tools.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/formChecker.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/glossaryPopupView.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/guardian.geolocation.js */
/* GeoLocation 1.0 */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/guardian.r2.EmailToAFriend.js */
ensurePackage('guardian.r2');
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/guardian.r2.OmnitureTracking.js */
/*
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/guardian.r2.ShareThis.js */
ensurePackage('guardian.r2');
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/mediamath-tag.js */
(function($) {
    // MediaMath Tag
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/modules/sticky-sidebar.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/omnitureAdInViewStats.js */
(function() {
    var inview = {
        init: function() {
            var self = this;

            // Markup every 12th paragraph
            if (guardian.page.type === 'article') {
                jQ('#article-body-blocks p:nth-of-type(12n)').attr('data-inview-name','12th para');
            }
            ...
            if (OAS_listpos) {
                ...
                for (var i = 0, j = ads.length; i < j; i++) {
                    ...
                    if (el) { el.setAttribute('data-inview-name', 'adslot: ' + adId);}
                }

            }


            this.nodes = jQ('[data-inview-name]');

            this.checkForVisibleNodes();
            jQ(window).on('scroll', this.debounce(function() {
        ...
        checkForVisibleNodes: function() {
            var self = this;
            this.nodes.each(function() {
                var el = this;
                if (!el._inviewHasFired && self.isVisible(el)) {
                    // Element is visible
                    var inviewEventName = 'viewed ' + el.getAttribute('data-inview-name');

                    self.trackAdImpression(inviewEventName);
        ...
        trackAdImpression: function(tagStr) {
            if (s) {
                s.linkTrackVars = 'eVar53,events';
                s.linkTrackEvents = 'event29';
                s.events = 'event29';
                s.eVar53 = guardian.page.type + ':' + tagStr;
                s.tl(true, 'o', tagStr);
            }
        }
    };
    ...
    // Wait until the Omniture pageview webbug has loaded
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/sendtoafriend.js */
...
/* e99f310607277d480270c398f825a63b32d019dd/common/scripts/signinTopNav.js */
jQ(document).ready(function () {
