...
meta:
    - {key: type, value: syllabus, display-value: Type, display: true,}
    - {key: title, value: Queer Performativity, display-value: Title, display: true}
    - {key: location, value: Duke, display-value: Location, display: true}
    - {key: creation-date, value: 1993, display-value: Date, display: true}
    - {key: creation-date, value: performativity, display-value: Date, display: true}
