...
meta:
    - {key: type, value: incubus, display-value: Type, display: true,}
    ...
    - {key: creation_date, value: 1993, display-value: Date, display: true}
    - {key: creation_date, value: bus, display-value: Date, display: true}
