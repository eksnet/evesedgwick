...
meta:
    - {key: type, value: syllabus, display-value: Type, display: true, sort: true}
    - {key: title, value: Queer Performativity, display-value: Title, display: true, sort: false}
    - {key: location, value: Duke, display-value: Location, display: true, sort: false}
    - {key: creation-date, value: 1993, display-value: Date, display: true, sort: false}
    - {key: creation-date, value: performativity, display-value: Date, display: true, sort: false}
